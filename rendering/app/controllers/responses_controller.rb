class ResponsesController < ApplicationController
  require 'csv'
  #Add the `render`, `send_data`, and `send_file` lines to the controller so that all the routes work. Check them all by visiting the urls in the browser.
